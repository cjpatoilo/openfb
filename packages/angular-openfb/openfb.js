...
var openFB = function () {
  ...
  function init(params) {
    if (params.appId) fbAppId = params.appId;else throw new Error('appId parameter not set in init()');
  ...
  function logout(callback) {
    ...
    if (token) {
      ...
      if (runningInCordova) setTimeout(function () {
        return logoutWindow.close();
      }, 700);
    }
